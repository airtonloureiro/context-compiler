        ...
        tools: [
            {
                ...
                description: "Compiles a local repository into a focused, highly compressed context markdown using Context Compiler and Graph-RAG. Use this when you need to understand or modify code across multiple files in a repository.",
                inputSchema: {
                    type: "object",
                    properties: {
                        repo_path: {
